...
public class InteractionFileReader extends AbstractMIFileReader{
    ...
    protected Map<String, Object> createDatasourceOptions(InputStream inputStreamToAnalyse, MIDataSourceOptionFactory optionFactory) throws IOException {
        ...
        options.put(MIFileDataSourceOptions.INTERACTION_CATEGORY_OPTION_KEY, InteractionCategory.mixed);
        return options;
    }
}
