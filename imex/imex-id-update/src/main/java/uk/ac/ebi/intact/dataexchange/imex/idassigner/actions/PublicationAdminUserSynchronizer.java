...
public class PublicationAdminUserSynchronizer extends ImexCentralUpdater{

    private static final Log log = LogFactory.getLog(PublicationAdminUserSynchronizer.class);
