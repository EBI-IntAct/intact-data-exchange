...
public class PublicationStatusSynchronizer extends ImexCentralUpdater{

    private static final Log log = LogFactory.getLog(PublicationStatusSynchronizer.class);
