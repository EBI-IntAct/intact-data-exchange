...
public class PublicationAdminGroupSynchronizer extends ImexCentralUpdater{

    private static final Log log = LogFactory.getLog(PublicationAdminGroupSynchronizer.class);
