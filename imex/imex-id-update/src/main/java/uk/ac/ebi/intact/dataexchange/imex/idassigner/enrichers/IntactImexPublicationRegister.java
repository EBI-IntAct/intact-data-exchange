...
import psidev.psi.mi.jami.imex.ImexPublicationRegister;
...
public class IntactImexPublicationRegister extends ImexPublicationRegister {
    private PublicationAdminUserSynchronizer adminUserSynchronizer;

    public IntactImexPublicationRegister(ImexCentralClient fetcher) {
        super(fetcher);
    }
