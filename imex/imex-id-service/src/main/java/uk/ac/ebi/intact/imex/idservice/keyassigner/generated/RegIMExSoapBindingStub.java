...
public class RegIMExSoapBindingStub extends org.apache.axis.client.Stub
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setReturnClass( SubmissionAxis.class );
    ...
    public SubmissionAxis newSubmission() throws java.rmi.RemoteException {
        if ( super.cachedEndpoint == null ) {
        ...
        try {
            ...
            if ( _resp instanceof java.rmi.RemoteException ) {
                ...
                try {
                    return (SubmissionAxis) _resp;
                } catch ( java.lang.Exception _exception ) {
                    return (SubmissionAxis) org.apache.axis.utils.JavaUtils.convert( _resp, SubmissionAxis.class );
                }
            }
    ...
    public SubmissionAxis newSubmission( int in0 ) throws java.rmi.RemoteException {
        if ( super.cachedEndpoint == null ) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
