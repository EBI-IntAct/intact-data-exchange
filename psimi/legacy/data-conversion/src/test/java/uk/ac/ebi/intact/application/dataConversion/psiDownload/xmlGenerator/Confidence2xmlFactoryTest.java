...
/**
 * Test the behaviour of the Confidence2xmlFactory
 *
 * @author Samuel Kerrien (skerrien@ebi.ac.uk)
 * @version $Id$
 */
public class Confidence2xmlFactoryTest extends PsiDownloadTest {

    /**
     * Returns this test suite. Reflection is used here to add all the testXXX() methods to the suite.
     */
    public static Test suite() {
        return new TestSuite( Confidence2xmlFactoryTest.class );
    }
    ...
    public void testGetInstance() {
        ...
        try {
            Confidence2xmlFactory.getInstance( session );
    ...
    public void testGetInstancePsi1() {
        ...
        Confidence2xmlI bsi = Confidence2xmlFactory.getInstance( session );

        assertNotNull( bsi );
        assertTrue( bsi instanceof Confidence2xmlPSI1 );
    }
    ...
    public void testGetInstancePsi2() {
        ...
        assertNotNull( bsi );
        assertTrue( bsi instanceof Confidence2xmlPSI2 );
    }
    ...
    public void testGetInstancePsi25() {
        ...
        assertNotNull( bsi );
        assertTrue( bsi instanceof Confidence2xmlPSI25 );
    }
}