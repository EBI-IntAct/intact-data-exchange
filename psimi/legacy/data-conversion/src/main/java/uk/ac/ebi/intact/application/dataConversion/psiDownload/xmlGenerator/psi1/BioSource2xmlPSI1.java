 ...
 * @version $Id$
 */
public class BioSource2xmlPSI1 extends AnnotatedObject2xmlPSI1 implements BioSource2xmlI {

    //////////////////////////////////////
    // Singleton's attribute and methods

    private static BioSource2xmlPSI1 ourInstance = new BioSource2xmlPSI1();

    public static BioSource2xmlPSI1 getInstance() {
        return ourInstance;
    }

    private BioSource2xmlPSI1() {
    }
