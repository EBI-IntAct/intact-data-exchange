 ...
 * @version $Id$
 */
public class BioSource2xmlPSI25 extends AnnotatedObject2xmlPSI25 implements BioSource2xmlI {

    ////////////////////////////
    // Constants

    public static final String HOST_ORGANISM_PARENT_NODE = "hostOrganismList";

    //////////////////////////////////////
    // Singleton's attribute and methods

    private static BioSource2xmlPSI25 ourInstance = new BioSource2xmlPSI25();

    public static BioSource2xmlPSI25 getInstance() {
        return ourInstance;
    }

    private BioSource2xmlPSI25() {
    }
