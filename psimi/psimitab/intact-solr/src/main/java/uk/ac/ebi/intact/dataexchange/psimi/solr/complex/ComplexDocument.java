...
public final class ComplexDocument {
    ...
    private Collection<String> complexID            = null ;
    private String             complexName          = null ;
    private Collection<String> complexOrganism      = null ;
    private Collection<String> complexAlias         = null ;
    private Collection<String> complexType          = null ;
    private Collection<String> complexXref          = null ;
    private String             complexAC            = null ;
    private String             description          = null ;
    private String             organismName         = null ;

    //Interactor attributes
    private Collection<String> interactorID         = null ;
    private Collection<String> interactorAlias      = null ;
    private Collection<String> interactorType       = null ;

    //Others attributes
    private Collection<String> biorole              = null ;
    private Collection<String> features             = null ;
    private Collection<String> source               = null ;
    private Collection<String> numberParticipants   = null ;
    private Collection<String> pathwayXref          = null ;
    private Collection<String> ecoXref              = null ;
    private Collection<String> publicationID        = null ;
