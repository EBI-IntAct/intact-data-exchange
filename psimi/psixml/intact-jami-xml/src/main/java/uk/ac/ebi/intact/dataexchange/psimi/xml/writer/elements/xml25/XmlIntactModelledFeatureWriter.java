...
public class XmlIntactModelledFeatureWriter extends XmlModelledFeatureWriter {
    public XmlIntactModelledFeatureWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex) {
        super(writer, objectIndex);
    }

    @Override
    protected void writeAttributes(ModelledFeature object) throws XMLStreamException {
