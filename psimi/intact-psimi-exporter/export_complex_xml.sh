...
then
      ...
      mvn -U clean install -Pexport-complex-xml,${PROFILE} -Drelease.folder=${RELEASE_FOLDER} -Drelease.buildFolder=${BUILD_FOLDER} -Dmaven.test.skip -Dmaven.repo.local=repository
else
      echo ""
