...
public class GOLineConverterVersion2Test extends UniprotExportBase {

    @Test
    public void test_go_convert_ok(){
        GoLineConverterVersion2 converter = new GoLineConverterVersion2();
    ...
    public void test_go_convert_simulation(){
        ...
        List<GOParameters2> parameters = converter.convertInteractionsIntoGOParameters(new HashSet<EncoreInteraction>(interactions), firstInteractor, context);
        ...
        for (GOParameters2 par : parameters){
            ...
            // feature chain
                ...
                Assert.assertTrue(par.getComponentXrefs().contains("GO:00xxxxxxxxx1"));
                Assert.assertTrue(par.getComponentXrefs().contains("GO:00xxxxxxxxx2"));
            }
