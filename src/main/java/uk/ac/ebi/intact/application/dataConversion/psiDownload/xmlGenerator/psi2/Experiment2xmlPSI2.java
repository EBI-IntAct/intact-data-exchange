 ...
 * @version $Id$
 */
public class Experiment2xmlPSI2 extends AnnotatedObject2xmlPSI2 implements Experiment2xmlI {
    ...
    private static Experiment2xmlPSI2 ourInstance = new Experiment2xmlPSI2();

    public static Experiment2xmlPSI2 getInstance() {
        return ourInstance;
    }

    private Experiment2xmlPSI2() {
    }
