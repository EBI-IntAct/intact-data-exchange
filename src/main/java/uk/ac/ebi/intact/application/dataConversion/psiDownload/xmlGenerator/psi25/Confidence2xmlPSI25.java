 ...
 * @version $Id$
 */
public class Confidence2xmlPSI25 extends AnnotatedObject2xmlPSI25 implements Confidence2xmlI {

    //////////////////////////////////////
    // Singleton's attribute and methods

    private static Confidence2xmlPSI25 ourInstance = new Confidence2xmlPSI25();

    public static Confidence2xmlPSI25 getInstance() {
        return ourInstance;
    }

    private Confidence2xmlPSI25() {
    }
