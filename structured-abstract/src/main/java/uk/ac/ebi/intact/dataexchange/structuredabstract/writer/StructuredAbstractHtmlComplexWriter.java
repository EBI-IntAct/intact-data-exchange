...
/**
 * HTML writer of Structured abstract for complexes
 *
...
public class StructuredAbstractHtmlComplexWriter extends AbstractStructuredAbstractComplexWriter{
    ...
    public StructuredAbstractHtmlComplexWriter(OutputStream stream) {
        super(stream);
    }

    public StructuredAbstractHtmlComplexWriter(File file) throws IOException {
        super(file);
    }
